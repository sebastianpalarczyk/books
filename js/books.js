document.addEventListener("DOMContentLoaded", function() {
    ...
    function addBookToDom(book) {
        ...
        buttonDelete.classList = "update";
        
        title.appendChild(titleAnchor);
        title.appendChild(divButton);

        titleAnchor.addEventListener("mouseover", function() {
            fetch(`https://app-palarczyk-books.herokuapp.com/book/${this.dataset.id}`,{
                method: "GET"
            }).then(() => {
        ...
        buttonDelete.addEventListener("click", function () {
            fetch(`https://app-palarczyk-books.herokuapp.com/book/${book.id}`, {
                method: "DELETE"
            }).then(response => {
                if (response.ok) {
...
+
    ...
    function addBook(event){
        ...
        fetch("https://app-palarczyk-books.herokuapp.com/book",{
            method: "POST",
    ...
    button.addEventListener("click", function(event){
            ...
            fetch(`https://app-palarczyk-books.herokuapp.com/book/${bookId}`,{
                method: "PUT", 
                body: JSON.stringify(book),
                headers: {
                    "Content-Type": "application/json"
    ...
    fetch("https://app-palarczyk-books.herokuapp.com/books",{
        method: "GET"})
